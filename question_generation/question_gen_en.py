...
class QuestionGenerator:
    ...
    def generate_questions(self, context: str, num_questions: int = 4, temperature: float = 1.0):
        """
        ...
        outputs = self.model.generate(input_ids,
                                      ...
                                      do_sample=True)
        questions = list({self.tokenizer.decode(output, skip_special_tokens=True) for output in outputs})
        return questions
